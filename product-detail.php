...
if(empty($p_id)){
    ...
    $product_data = $db->query("SELECT * FROM `product` WHERE `slug` = '$p_id'");
...
?>
        ...
        <!-- /Page Title -->
        <!-- Product Main -->
         <form action="admin/manage/manage-cart.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical"
                                        ...
                                        <div class="swiper-wrapper stagger-wrap">
                                            <div class="swiper-slide stagger-item" data-size="XS" data-color="blue">
                                                <div class="item">
                                                    <img class="lazyload" data-src="admin/uploads/products/<?= $product->product_image?>"
                                                        src="admin/uploads/products/<?= $product->product_image?>" alt="img-product">
                                                </div>
                                            </div>
                                        ...
                                        <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide" data-size="XS" data-color="blue">
                                                    <a href="admin/uploads/products/<?= $product->product_image?>" target="_blank" class="item"
                                                        data-pswp-width="860px" data-pswp-height="1146px">
                                                        <img class="tf-image-zoom lazyload" data-zoom="admin/uploads/products/<?= $product->product_image?>"
                                                            data-src="admin/uploads/products/<?= $product->product_image?>"
                                                            src="admin/uploads/products/<?= $product->product_image?>" alt="">
                                                    </a>
                                                </div>
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-heading">
                                        <div class="product-info-price price-wrap">
                                            <span class="price-new price-on-sale h2 fw-4"><?= $product->product_selling_price?></span>
                                            <span class="price-old compare-at-price h6"><?= $product->product_market_price	?></span>
 ...
 <div class="offcanvas offcanvas-end popup-shopping-cart" id="shoppingCart">
    ...
    <!-- Compare Color -->
    <div class="modal modalCentered fade modal-compare_color" id="compareColor">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-heading">
                    <h2 class="fw-normal">Compare color</h2>
                    <span class="icon-close icon-close-popup" data-bs-dismiss="modal"></span>
                </div>
                <div class="compare-color_list list-empty tf-grid-layout tf-col-4 gap-0">
                    <p class="box-text_empty h6 text-main">Your compare is curently empty</p>
                    <div class="compare-color_item file-delete">
                        <div class="compare_image">
                            <img class="lazyload" src="images/products/product-4.jpg" data-src="images/products/product-4.jpg" alt="Image">
                            <span class="remove">
                                <i class="icon icon-trash"></i>
                            </span>
                        </div>
                        <div class="compare_colour">
                            <span class="color bg-teal-blue"></span>
                            <span class="fw-medium text-black">Teal Blue</span>
                        </div>
                        <div class="compare_bot">
                            <div class="tf-select style-border">
                                <select class="h6">
                                    <option>XS - $49,99 </option>
                                    <option selected="selected">S - $69,99 </option>
                                    <option>M - $79,99 </option>
                                    <option>XL - $89,99 </option>
                                </select>
                            </div>
                            <a href="#shoppingCart" data-bs-toggle="offcanvas" class="tf-btn animate-btn rounded-0 w-100">
                                ADD TO CART
                                <i class="icon icon-shopping-cart-simple"></i>
                            </a>
                        </div>
                    ...
                    <div class="compare-color_item file-delete">
                        <div class="compare_image">
                            <img class="lazyload" src="images/products/product-21.jpg" data-src="images/products/product-21.jpg" alt="Image">
                            <span class="remove">
                                <i class="icon icon-trash"></i>
                            </span>
                        </div>
                        <div class="compare_colour">
                            <span class="color bg-black"></span>
                            <span class="fw-medium text-black">Black</span>
                        </div>
                        <div class="compare_bot">
                            <div class="tf-select style-border">
                                <select class="h6">
                                    <option>XS - $79,99 </option>
                                    <option>S - $89,99 </option>
                                    <option selected="selected">M - $99,99 </option>
                                    <option>XL - $109,99 </option>
                                    <option>2XL - $109,99 </option>
                                </select>
                            </div>
                            <a href="#shoppingCart" data-bs-toggle="offcanvas" class="tf-btn animate-btn rounded-0 w-100">
                                ADD TO CART
                    ...
                    <div class="compare-color_item file-delete">
                        <div class="compare_image">
                            <img class="lazyload" src="images/products/product-30.jpg" data-src="images/products/product-30.jpg" alt="Image">
                            <span class="remove">
                                <i class="icon icon-trash"></i>
                            </span>
                        </div>
                        <div class="compare_colour">
                            <span class="color bg-medium-gray"></span>
                            <span class="fw-medium text-black">Medium grey</span>
                        </div>
                        <div class="compare_bot">
                            <div class="tf-select style-border">
                                <select class="h6">
                                    <option>S - $119,99 </option>
                                    <option selected="selected">M - $129,99 </option>
                                </select>
                            </div>
                            <a href="#shoppingCart" data-bs-toggle="offcanvas" class="tf-btn animate-btn rounded-0 w-100">
                                ADD TO CART
                    ...
                    <div class="compare-color_item file-delete">
                        <div class="compare_image">
                            <img class="lazyload" src="images/products/product-26.jpg" data-src="images/products/product-26.jpg" alt="Image">
                            <span class="remove">
                                <i class="icon icon-trash"></i>
                            </span>
                        </div>
                        <div class="compare_colour">
                            ...
                            <span class="fw-medium text-black">Grey</span>
                        </div>
                        <div class="compare_bot">
                            <div class="tf-select style-border">
                                <select class="h6">
    ...
    <!-- /Compare Color -->
    <!-- Ask -->
    <div class="modal modalCentered fade modal-ask_question" id="askQuestion">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-heading">
                ...
                <form class="form-ask">
                    <div class="form_content">
                        ...
                        <textarea placeholder="Message" style="height: 180px;"></textarea>
                    </div>
    ...
    <!-- /Ask -->
    <!-- Ship And Delivery -->
    <div class="modal modalCentered fade modal-ship_delivery" id="shipAndDelivery">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-heading">
                    <h2 class="fw-normal">Shipping & Delivery</h2>
                    <span class="icon-close icon-close-popup" data-bs-dismiss="modal"></span>
                </div>
                <div class="legal-list">
                    <div class="legal-item">
                        <h5 class="legal_title">Returns & Refunds:</h5>
                        <p class="legal_label h6">
                            Enjoy free standard shipping on all orders over 50! For orders under $50, a flat rate of
                            $5 applies. We want you to love your purchase! If you're not completely satisfied, you can return unworn and
                            unwashed items within 30 days for a full refund or exchange. Please see our full policy for details.
                        </p>
                    </div>
                    <div class="legal-item">
                        <h5 class="legal_title">Shipping:</h5>
                        <p class="legal_label h6">
                            Enjoy swift and reliable delivery! We offer free standard shipping on all orders over $50 within Vietnam. For orders
                            under $50, a flat shipping fee of $5 will apply. Express shipping options are also available at checkout. Please allow
                            1-3 business days for order processing and 2-5 business days for delivery, depending on your location.
                        </p>
                    </div>
                    <div class="legal-item">
                        <h5 class="legal_title">Help</h5>
                        <p class="legal_label h6">
                            If you have any questions regarding our services, please contact us using the information below.
                        </p>
                        <ul class="contact-list">
                            ...
                            <li>
                                ...
                                <span class="br-line"></span>
                                <a href="tel:+88001234567" class="h6 link text-main">+8(800) 123 4567</a>
                            </li>
                            <li>
                                <i class="icon icon-envelope-simple"></i>
                                <span class="br-line"></span>
                                <a href="mailto:themesflat@support.com" class="h6 link text-main">themesflat@support.com</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="wrap-code style-1">
                    <p class="coppyText h6" id="coppyText">http://themesflat.com</p>
                    <div class="btn-coppy-text tf-btn">Copy</div>
                </div>
            </div>
        </div>
    </div>
