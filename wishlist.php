                ...
                <div class="tf-grid-layout tf-col-2 md-col-3 xl-col-4 wrapper-wishlist">
                    ...
                    <div class="card-product grid style-2 has-size">
                        <div class="card-product_wrapper">
                            <a href="product-detail.html" class="product-img">
                                <img class="lazyload img-product" src="images/products/product-1.jpg" data-src="images/products/product-1.jpg"
                                    alt="Product">
                                <img class="lazyload img-hover" src="images/products/product-2.jpg" data-src="images/products/product-2.jpg"
                                    alt="Product">
                            </a>
                    ...
                    <div class="card-product grid style-2 has-size">
                        <div class="card-product_wrapper">
                            ...
                            <div class="variant-box bottom-0 start-0 end-0">
                                <div class="product-size_list type-2">
                                    <span class="size-item h6">XS</span>
                                    <span class="size-item h6">M</span>
                                </div>
                            </div>
                            <ul class="product-action_list">
                                <li>
                    ...
                    <div class="card-product grid style-2 has-size">
                        <div class="card-product_wrapper">
                            ...
                            <div class="variant-box bottom-0 start-0 end-0">
                                <div class="product-size_list type-2">
                                    <span class="size-item h6">XS</span>
                                    <span class="size-item h6">S</span>
                                    <span class="size-item h6">M</span>
                                </div>
                            </div>
                            <ul class="product-action_list">
                        ...
                        <div class="card-product_wrapper">
                            ...
                            <div class="variant-box bottom-0 start-0 end-0">
                                <div class="product-size_list type-2">
                                    ...
                                    <span class="size-item h6">S</span>
                                    <span class="size-item h6">M</span>
                                    <span class="size-item h6">L</span>
                                </div>
                            </div>
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    ...
                                    <div class="tf-mini-cart-info">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <i class="icon link icon-close remove fs-12"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="tf-mini-cart-item file-delete">
...
<!-- Mirrored from ochaka.vercel.app/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Jul 2025 09:57:22 GMT -->
</html>